...
export const TREATMENTS: Treatment[] = [
    ...
    },
    {
        ...
        description: '피부결+톤업 동시 효과 (딱지 없음, 거친 느낌 5일)',
        price: '165,000',
        downtime: 'Sandpaper Texture',
        category: 'Pigmentation',
        image: '/images/equipment/lavieen.png', // Placeholder needed?
    ...
    },
    {
        ...
        description: '경계가 명확한 색소 강력 제거 (듀오덤 7일)',
        price: '300,000',
        downtime: 'Tape Required 7 Days',
        category: 'Pigmentation',
    ...
    },
    {
        ...
        description: '저통증 색소 제거 + 재생 관리 포함',
        price: '350,000',
        downtime: 'Tape Required 7 Days',
        category: 'Pigmentation',
    ...
    // --- 5. Acne ---
    {
        ...
        name: '마일드 PDT',
        nameEn: 'Mild PDT',
        description: '가성비 여드름 치료 (시술 후 2일간 자외선 차단 필수)',
        price: '120,000',
    ...
    },
    {
        ...
        name: '골드 PTT',
        nameEn: 'Gold PTT',
        description: '특수 골드 입자로 피지선 파괴 (자외선 영향 없음)',
        price: '330,000',
        downtime: 'None',
        category: 'Acne',
